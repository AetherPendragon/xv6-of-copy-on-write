...
free(void *ap)
{
 ...
 6c8:	d1c7b783          	ld	a5,-740(a5) # 13e0 <freep>
 ...
 6f0:	00e6ea63          	bltu	a3,a4,704 <free+0x4a>
{
 ...
 732:	caf73923          	sd	a5,-846(a4) # 13e0 <freep>
}
 736:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 75c:	c8853503          	ld	a0,-888(a0) # 13e0 <freep>
 ...
 78c:	c5890913          	addi	s2,s2,-936 # 13e0 <freep>
  if(p == (char*)-1)
 790:	5afd                	li	s5,-1
 ...
 7a0:	c5478793          	addi	a5,a5,-940 # 13f0 <base>
 ...
 81e:	bca73323          	sd	a0,-1082(a4) # 13e0 <freep>
      return (void*)(p + 1);
