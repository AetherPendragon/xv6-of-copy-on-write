...
free(void *ap)
{
 ...
 6a2:	d427b783          	ld	a5,-702(a5) # 13e0 <freep>
 ...
 6ca:	00e6ea63          	bltu	a3,a4,6de <free+0x4a>
{
 ...
 70c:	ccf73c23          	sd	a5,-808(a4) # 13e0 <freep>
}
 710:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 736:	cae53503          	ld	a0,-850(a0) # 13e0 <freep>
 ...
 766:	c7e90913          	addi	s2,s2,-898 # 13e0 <freep>
  if(p == (char*)-1)
 76a:	5afd                	li	s5,-1
 ...
 77a:	c7a78793          	addi	a5,a5,-902 # 13f0 <base>
 77e:	00001717          	auipc	a4,0x1
 782:	c6f73123          	sd	a5,-926(a4) # 13e0 <freep>
 786:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f8:	bea73623          	sd	a0,-1044(a4) # 13e0 <freep>
      return (void*)(p + 1);
