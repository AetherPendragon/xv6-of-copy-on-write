...
free(void *ap)
{
 ...
 8e4:	be07b783          	ld	a5,-1056(a5) # 14c0 <freep>
 ...
 90c:	00e6ea63          	bltu	a3,a4,920 <free+0x4a>
{
 ...
 94e:	b6f73b23          	sd	a5,-1162(a4) # 14c0 <freep>
}
 952:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 978:	b4c53503          	ld	a0,-1204(a0) # 14c0 <freep>
 ...
 9a8:	b1c90913          	addi	s2,s2,-1252 # 14c0 <freep>
  if(p == (char*)-1)
 9ac:	5afd                	li	s5,-1
 ...
 9bc:	f1878793          	addi	a5,a5,-232 # 18d0 <base>
 9c0:	00001717          	auipc	a4,0x1
 9c4:	b0f73023          	sd	a5,-1280(a4) # 14c0 <freep>
 9c8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a3a:	a8a73523          	sd	a0,-1398(a4) # 14c0 <freep>
      return (void*)(p + 1);
