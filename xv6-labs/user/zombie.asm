...
free(void *ap)
{
 ...
 664:	d807b783          	ld	a5,-640(a5) # 13e0 <freep>
 ...
 68c:	00e6ea63          	bltu	a3,a4,6a0 <free+0x4a>
{
 ...
 6ce:	d0f73b23          	sd	a5,-746(a4) # 13e0 <freep>
}
 6d2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6f8:	cec53503          	ld	a0,-788(a0) # 13e0 <freep>
 ...
 728:	cbc90913          	addi	s2,s2,-836 # 13e0 <freep>
  if(p == (char*)-1)
 72c:	5afd                	li	s5,-1
 ...
 73c:	cb878793          	addi	a5,a5,-840 # 13f0 <base>
 ...
 7ba:	c2a73523          	sd	a0,-982(a4) # 13e0 <freep>
      return (void*)(p + 1);
