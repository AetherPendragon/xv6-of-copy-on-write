...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11a4:	6407b783          	ld	a5,1600(a5) # 27e0 <freep>
    ...
    11cc:	00e6ea63          	bltu	a3,a4,11e0 <free+0x4a>
{
  ...
  freep = p;
    ...
    120e:	5cf73b23          	sd	a5,1494(a4) # 27e0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1238:	5ac53503          	ld	a0,1452(a0) # 27e0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1268:	57c90913          	addi	s2,s2,1404 # 27e0 <freep>
  if(p == (char*)-1)
    126c:	5afd                	li	s5,-1
    ...
    127c:	5e078793          	addi	a5,a5,1504 # 2858 <base>
    1280:	00001717          	auipc	a4,0x1
    1284:	56f73023          	sd	a5,1376(a4) # 27e0 <freep>
  ...
  if(p == (char*)-1)
    ...
    12fa:	4ea73523          	sd	a0,1258(a4) # 27e0 <freep>
      return (void*)(p + 1);
