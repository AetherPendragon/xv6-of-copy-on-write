...
free(void *ap)
{
 ...
 69c:	d487b783          	ld	a5,-696(a5) # 13e0 <freep>
 ...
 6c4:	00e6ea63          	bltu	a3,a4,6d8 <free+0x4a>
{
 ...
 706:	ccf73f23          	sd	a5,-802(a4) # 13e0 <freep>
}
 70a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 730:	cb453503          	ld	a0,-844(a0) # 13e0 <freep>
 ...
 760:	c8490913          	addi	s2,s2,-892 # 13e0 <freep>
  if(p == (char*)-1)
 764:	5afd                	li	s5,-1
 ...
 774:	c8078793          	addi	a5,a5,-896 # 13f0 <base>
 ...
 7f2:	bea73923          	sd	a0,-1038(a4) # 13e0 <freep>
      return (void*)(p + 1);
