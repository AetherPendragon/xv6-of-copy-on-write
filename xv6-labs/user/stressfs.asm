...
free(void *ap)
{
 ...
 746:	c9e7b783          	ld	a5,-866(a5) # 13e0 <freep>
...
malloc(uint nbytes)
{
 ...
 7da:	c0a53503          	ld	a0,-1014(a0) # 13e0 <freep>
 ...
 802:	004a1a1b          	slliw	s4,s4,0x4
    ...
    if(p == freep)
 806:	00001917          	auipc	s2,0x1
 80a:	bda90913          	addi	s2,s2,-1062 # 13e0 <freep>
  if(p == (char*)-1)
 80e:	5afd                	li	s5,-1
 ...
 81e:	bd678793          	addi	a5,a5,-1066 # 13f0 <base>
 822:	00001717          	auipc	a4,0x1
 826:	baf73f23          	sd	a5,-1090(a4) # 13e0 <freep>
 82a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 89c:	b4a73423          	sd	a0,-1208(a4) # 13e0 <freep>
      return (void*)(p + 1);
