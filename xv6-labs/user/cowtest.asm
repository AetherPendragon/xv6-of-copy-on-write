...
simpletest()
{
  ...
  22:	55450513          	addi	a0,a0,1364 # 5555554 <base+0x55500c4>
  ...
  6a:	aac50513          	addi	a0,a0,-1364 # fffffffffaaaaaac <base+0xfffffffffaaa561c>
  ...
  9e:	55458593          	addi	a1,a1,1364 # 5555554 <base+0x55500c4>
  ...
  e2:	55458593          	addi	a1,a1,1364 # 5555554 <base+0x55500c4>
...
threetest()
{
 ...
 154:	00a92023          	sw	a0,0(s2) # 5556000 <base+0x5550b70>
  for(char *q = p; q < p + sz; q += 4096){
 ...
 25e:	9726                	add	a4,a4,s1
      *(int*)q = 9999;
 260:	6789                	lui	a5,0x2
 262:	70f78793          	addi	a5,a5,1807 # 270f <buf+0x27f>
    for(char *q = p; q < p + (sz/2); q += 4096){
 266:	6685                	lui	a3,0x1
      *(int*)q = 9999;
 268:	c09c                	sw	a5,0(s1)
...
filetest()
{
 ...
 2f0:	1af70223          	sb	a5,420(a4) # 2490 <buf>

  for(int i = 0; i < 4; i++){
 2f4:	fc042c23          	sw	zero,-40(s0)
    if(pipe(fds) != 0){
 2f8:	00001497          	auipc	s1,0x1
 2fc:	18848493          	addi	s1,s1,392 # 1480 <fds>
  for(int i = 0; i < 4; i++){
 300:	490d                	li	s2,3
    if(pipe(fds) != 0){
 302:	8526                	mv	a0,s1
 ...
 366:	12e74703          	lbu	a4,302(a4) # 2490 <buf>
 ...
 3d2:	0c258593          	addi	a1,a1,194 # 2490 <buf>
 3d6:	00001517          	auipc	a0,0x1
 3da:	0aa52503          	lw	a0,170(a0) # 1480 <fds>
 ...
 3fe:	0967a783          	lw	a5,150(a5) # 2490 <buf>
...
gets(char *buf, int max)
{
 ...
 5fe:	00098023          	sb	zero,0(s3) # 199a000 <base+0x1994b70>
  return buf;
}
 602:	855e                	mv	a0,s7
...
free(void *ap)
{
 ...
 b0e:	97e7b783          	ld	a5,-1666(a5) # 1488 <freep>
 ...
 b36:	00e6ea63          	bltu	a3,a4,b4a <free+0x4a>
{
 ...
 b78:	90f73a23          	sd	a5,-1772(a4) # 1488 <freep>
}
 b7c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 ba2:	8ea53503          	ld	a0,-1814(a0) # 1488 <freep>
 ...
 bca:	004a1a1b          	slliw	s4,s4,0x4
    ...
    if(p == freep)
 bce:	00001917          	auipc	s2,0x1
 bd2:	8ba90913          	addi	s2,s2,-1862 # 1488 <freep>
  if(p == (char*)-1)
 bd6:	5afd                	li	s5,-1
 ...
 be0:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
 be2:	00005797          	auipc	a5,0x5
 be6:	8ae78793          	addi	a5,a5,-1874 # 5490 <base>
 bea:	00001717          	auipc	a4,0x1
 bee:	88f73f23          	sd	a5,-1890(a4) # 1488 <freep>
 bf2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 c64:	82a73423          	sd	a0,-2008(a4) # 1488 <freep>
      return (void*)(p + 1);
