...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11f4:	2b07b783          	ld	a5,688(a5) # 24a0 <freep>
    ...
    121c:	00e6ea63          	bltu	a3,a4,1230 <free+0x4a>
{
  ...
  freep = p;
    ...
    125e:	24f73323          	sd	a5,582(a4) # 24a0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1288:	21c53503          	ld	a0,540(a0) # 24a0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12b8:	1ec90913          	addi	s2,s2,492 # 24a0 <freep>
  if(p == (char*)-1)
    12bc:	5afd                	li	s5,-1
    ...
    12cc:	5d078793          	addi	a5,a5,1488 # 2898 <base>
    12d0:	00001717          	auipc	a4,0x1
    12d4:	1cf73823          	sd	a5,464(a4) # 24a0 <freep>
  ...
  if(p == (char*)-1)
    ...
    134a:	14a73d23          	sd	a0,346(a4) # 24a0 <freep>
      return (void*)(p + 1);
