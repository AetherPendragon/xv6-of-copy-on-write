...
free(void *ap)
{
 ...
 916:	b5e7b783          	ld	a5,-1186(a5) # 1470 <freep>
 ...
 93e:	00e6ea63          	bltu	a3,a4,952 <free+0x4a>
{
 ...
 980:	aef73a23          	sd	a5,-1292(a4) # 1470 <freep>
}
 984:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9aa:	aca53503          	ld	a0,-1334(a0) # 1470 <freep>
 ...
 9d2:	004a1a1b          	slliw	s4,s4,0x4
    ...
    if(p == freep)
 9d6:	00001917          	auipc	s2,0x1
 9da:	a9a90913          	addi	s2,s2,-1382 # 1470 <freep>
  if(p == (char*)-1)
 9de:	5afd                	li	s5,-1
 ...
 9ee:	aa678793          	addi	a5,a5,-1370 # 1490 <base>
 9f2:	00001717          	auipc	a4,0x1
 9f6:	a6f73f23          	sd	a5,-1410(a4) # 1470 <freep>
 9fa:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a6c:	a0a73423          	sd	a0,-1528(a4) # 1470 <freep>
      return (void*)(p + 1);
