...
free(void *ap)
{
 ...
 732:	cc27b783          	ld	a5,-830(a5) # 13f0 <freep>
 ...
 75a:	00e6ea63          	bltu	a3,a4,76e <free+0x4a>
{
 ...
 79c:	c4f73c23          	sd	a5,-936(a4) # 13f0 <freep>
}
 7a0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c6:	c2e53503          	ld	a0,-978(a0) # 13f0 <freep>
 ...
 7f6:	bfe90913          	addi	s2,s2,-1026 # 13f0 <freep>
  if(p == (char*)-1)
 7fa:	5afd                	li	s5,-1
 ...
 80a:	bfa78793          	addi	a5,a5,-1030 # 1400 <base>
 80e:	00001717          	auipc	a4,0x1
 812:	bef73123          	sd	a5,-1054(a4) # 13f0 <freep>
 816:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 888:	b6a73623          	sd	a0,-1172(a4) # 13f0 <freep>
      return (void*)(p + 1);
