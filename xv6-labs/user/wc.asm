...
free(void *ap)
{
 ...
 7ca:	c7a7b783          	ld	a5,-902(a5) # 1440 <freep>
 ...
 7f2:	00e6ea63          	bltu	a3,a4,806 <free+0x4a>
{
 ...
 834:	c0f73823          	sd	a5,-1008(a4) # 1440 <freep>
}
 838:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 85e:	be653503          	ld	a0,-1050(a0) # 1440 <freep>
 ...
 886:	004a1a1b          	slliw	s4,s4,0x4
    ...
    if(p == freep)
 88a:	00001917          	auipc	s2,0x1
 88e:	bb690913          	addi	s2,s2,-1098 # 1440 <freep>
  if(p == (char*)-1)
 892:	5afd                	li	s5,-1
 ...
 8a2:	db278793          	addi	a5,a5,-590 # 1650 <base>
 8a6:	00001717          	auipc	a4,0x1
 8aa:	b8f73d23          	sd	a5,-1126(a4) # 1440 <freep>
 8ae:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 920:	b2a73223          	sd	a0,-1244(a4) # 1440 <freep>
      return (void*)(p + 1);
