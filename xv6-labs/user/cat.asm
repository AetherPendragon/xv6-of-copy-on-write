...
free(void *ap)
{
 ...
 75c:	cc87b783          	ld	a5,-824(a5) # 1420 <freep>
 ...
 784:	00e6ea63          	bltu	a3,a4,798 <free+0x4a>
{
 ...
 7c6:	c4f73f23          	sd	a5,-930(a4) # 1420 <freep>
}
 7ca:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f0:	c3453503          	ld	a0,-972(a0) # 1420 <freep>
 ...
 820:	c0490913          	addi	s2,s2,-1020 # 1420 <freep>
  if(p == (char*)-1)
 824:	5afd                	li	s5,-1
 ...
 834:	e0078793          	addi	a5,a5,-512 # 1630 <base>
 838:	00001717          	auipc	a4,0x1
 83c:	bef73423          	sd	a5,-1048(a4) # 1420 <freep>
 840:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8b2:	b6a73923          	sd	a0,-1166(a4) # 1420 <freep>
      return (void*)(p + 1);
